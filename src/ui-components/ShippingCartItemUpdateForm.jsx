...
export default function ShippingCartItemUpdateForm(props) {
  const {
    id: idProp,
    shippingCartItem: shippingCartItemModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = shippingCartItemRecord
      ? { ...initialValues, ...shippingCartItemRecord }
      : initialValues;
  ...
  const [shippingCartItemRecord, setShippingCartItemRecord] = React.useState(
    shippingCartItemModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(ShippingCartItem, idProp)
        : shippingCartItemModelProp;
      setShippingCartItemRecord(record);
    };
    queryData();
  }, [idProp, shippingCartItemModelProp]);
  React.useEffect(resetStateValues, [shippingCartItemRecord]);
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            ShippingCartItem.copyOf(shippingCartItemRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ShippingCartItemUpdateForm")}
      {...rest}
    >
      <TextField
        label="Customer id"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || shippingCartItemModelProp)}
